...
export default function RecentTransactionList({ accountsList, className = '' }: Props) {
  ...
  const recentTransactionsTable = {
    ...
    config: {
      primaryColumn: translateRaw('RECENT_TRANSACTIONS_DATE') || 'Date',
      sortableColumn: translateRaw('RECENT_TRANSACTIONS_DATE') || 'Date',
      sortFunction: (a: any, b: any) => b.props.date - a.props.date,
      hiddenHeadings: [translateRaw('RECENT_TRANSACTIONS_VIEW_MORE') || 'View More'],
      iconColumns: [translateRaw('RECENT_TRANSACTIONS_VIEW_MORE') || 'View More']
    }
  };
  return (
    <DashboardPanel
